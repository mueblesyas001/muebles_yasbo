...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="flex-grow-1">
            <h1 class="h2 mb-1 text-primary fw-bold">Gestión de Compras</h1>
            <p class="text-muted mb-0">Administra el registro y seguimiento de todas las compras del sistema</p>
        </div>
        <div>
    ...
    <!-- Estadísticas de compras (con filtros aplicados) -->
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="text-muted mb-2">Compras Filtradas</h6>
                            <h3 class="mb-0">{{ $comprasFiltradas->count() }}</h3>
                        </div>
                    ...
                    <small class="text-muted d-block mt-2">
                        @if(request()->anyFilled(['id', 'fecha', 'fecha_desde', 'fecha_hasta', 'proveedor_id', 'monto_min', 'monto_max', 'producto']))
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="text-muted mb-2">Compras Hoy</h6>
                            <h3 class="mb-0">
                                {{ $comprasFiltradas->filter(function($compra) {
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mb-0 text-primary">${{ number_format($comprasFiltradas->sum('Total'), 2) }}</h3>
                        </div>
                        <div class="avatar-sm bg-primary bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center">
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="text-muted mb-2">Promedio Compra</h6>
                            <h3 class="mb-0">
                                ${{ $comprasFiltradas->count() > 0 ? number_format($comprasFiltradas->avg('Total'), 2) : '0.00' }}
                            </h3>
                        </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        <label class="form-label small text-muted">
                            <i class="fas fa-hashtag me-1"></i> ID de Compra
                        </label>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-select" name="proveedor_id" aria-label="Proveedor">
    ...
    @php
        $filtrosActivos = [];
        if(request('id')) $filtrosActivos[] = ['ID Compra', request('id')];
        ...
        if(request('proveedor_id')) {
            ...
            $filtrosActivos[] = ['Proveedor', $proveedor ? ($proveedor->Nombre ?? '') . ' ' . ($proveedor->ApPaterno ?? $proveedor->ApellidoPaterno ?? '') : 'No encontrado'];
        }
    ...
    <!-- Tabla de compras (con paginación) -->
            ...
            <div class="d-flex align-items-center gap-2">
                <div class="text-muted small">
                    ...
                    <span class="badge bg-light text-dark">
                        {{ 
                            request('sort_by', 'Fecha_compra') == 'Fecha_compra' ? 'Fecha' : 
                        ...
                        <tr class="align-middle">
                            ...
                            <td class="text-center">
                                <button class="btn btn-sm btn-outline-secondary btn-expand" 
                                        ...
                                        aria-expanded="false"
                                        aria-controls="detallesCompra{{ $compra->id }}">
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="mb-0 fw-semibold">Compra #{{ $compra->id }}</h6>
                                        <small class="text-muted">
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <span class="fw-medium">{{ Str::limit($proveedorNombreCompleto, 25) }}</span>
                                        @if($compra->proveedor)
                                            <br>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="mb-0 fw-bold text-primary">${{ number_format($compra->Total, 2) }}</h6>
                                    </div>
                                </div>
                            </td>
                            <td class="text-end">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="card border-0 shadow-sm h-100">
                                                    <div class="card-body">
                                                        <h6 class="fw-bold mb-3 text-primary">
                                                            <i class="fas fa-chart-pie me-2"></i>Resumen de Compra
                                                        </h6>
                                                        ...
                                                        <div class="mt-3">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <small class="text-muted">Proveedor ID: {{ $compra->proveedor->id ?? 'N/A' }}</small>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        @endif
                        ...
                        <tr>
                            <td colspan="7" class="text-center py-5">
                                <div class="py-5">
                                    ...
                                    <h4 class="text-muted fw-bold mb-3">No hay compras registradas</h4>
                                    ...
                                    <a href="{{ route('compras.index') }}" class="btn btn-outline-secondary me-2">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-body text-center py-4">
                ...
                <p class="fs-6">
                    Estás a punto de eliminar la compra <strong id="deleteCompraId"></strong>
                </p>
                <p class="text-danger small mb-0">
                    Valor total: <strong id="deleteCompraTotal"></strong><br>
...
// CORRECCIÓN: Función para el modal de eliminación de compras
function setDeleteCompra(compraId, total) {
    try {
        // Actualizar la información en el modal
        const idElement = document.getElementById('deleteCompraId');
        const totalElement = document.getElementById('deleteCompraTotal');
        
        if (idElement) {
            idElement.textContent = '#' + compraId;
        }
        ...
        const actionUrl = "{{ route('compras.destroy', ':id') }}".replace(':id', compraId);
        
        // Método 2: Alternativo si el anterior no funciona
        // const actionUrl = "{{ url('compras') }}/" + compraId;
        ...
        console.error('Error en setDeleteCompra:', error);
...
@media (max-width: 768px) {
    ...
    .detalle-compra-row .row {
        flex-direction: column;
    }
    
    .detalle-compra-row .col-md-8,
    .detalle-compra-row .col-md-4 {
        width: 100% !important;
        margin-bottom: 1rem;
    }
...
.detalle-compra-row .card-body {
    padding: 1.5rem;
}

.detalle-compra-row h6 {
    font-size: 0.95rem;
}

.detalle-compra-row .table-sm th,
.detalle-compra-row .table-sm td {
    padding: 0.5rem;
    font-size: 0.85rem;
}

/* Ajustes específicos para compras */
.text-primary {
...
.detalle-compra-row .table tbody tr:hover {

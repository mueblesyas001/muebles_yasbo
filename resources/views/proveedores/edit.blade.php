                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="mb-0 text-muted" style="font-size: 0.9rem;">
                                    ...
                                    Modifique los campos necesarios para actualizar el proveedor
                                </p>
                            </div>
                        </div>
                                        ...
                                        <div class="form-group-enhanced">
                                            ...
                                            <div class="input-meta">
                                                <div class="char-counter">
                                                    ...
                                                    <span id="nombreCount">{{ strlen($proveedor->Nombre) }}/255</span>
                                                </div>
                                        ...
                                        <div class="form-group-enhanced">
                                            ...
                                            <div class="input-wrapper" data-required="true">
                                                ...
                                                <input type="text" 
                                                       ...
                                                       id="ApPaterno" 
                                                       name="ApPaterno" 
                                                       value="{{ old('ApPaterno', $proveedor->ApPaterno) }}" 
                                            ...
                                            <div class="input-meta">
                                                <div class="char-counter">
                                                    <i class="fas fa-text-height"></i>
                                                    <span id="apPaternoCount">{{ strlen($proveedor->ApPaterno) }}/255</span>
                                                </div>
                                                <div class="input-hint">
                                                    Primer apellido
                                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group-enhanced">
                                            ...
                                            <div class="input-meta">
                                                <div class="char-counter">
                                                    <i class="fas fa-text-height"></i>
                                                    <span id="apMaternoCount">{{ strlen($proveedor->ApMaterno) }}/255</span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group-enhanced">
                                            ...
                                            <div class="gender-selector-grid" data-required="true" id="genderGroup">
                                                <div class="gender-option-card {{ old('Sexo', $proveedor->Sexo) == 'Masculino' ? 'selected' : '' }}" data-gender="Masculino">
                                                    ...
                                                    <input type="radio" name="Sexo" value="Masculino" id="sexo_m" 
                                                           class="gender-input" {{ old('Sexo', $proveedor->Sexo) == 'Masculino' ? 'checked' : '' }} required>
                                                    <div class="selection-indicator">
                                                        <i class="fas fa-check"></i>
                                                    </div>
                                                </div>
                                                <div class="gender-option-card {{ old('Sexo', $proveedor->Sexo) == 'Femenino' ? 'selected' : '' }}" data-gender="Femenino">
                                                    <div class="gender-icon-wrapper">
                                                        <i class="fas fa-venus"></i>
                                                    </div>
                                                    <span class="gender-label">Femenino</span>
                                                    <input type="radio" name="Sexo" value="Femenino" id="sexo_f"
                                                           class="gender-input" {{ old('Sexo', $proveedor->Sexo) == 'Femenino' ? 'checked' : '' }}>
                                                    <div class="selection-indicator">
                                                        <i class="fas fa-check"></i>
                                                    </div>
                                                </div>
                                                <div class="gender-option-card {{ old('Sexo', $proveedor->Sexo) == 'Otro' ? 'selected' : '' }}" data-gender="Otro">
                                                    <div class="gender-icon-wrapper">
                                                        <i class="fas fa-transgender-alt"></i>
                                                    </div>
                                                    <span class="gender-label">Otro</span>
                                                    <input type="radio" name="Sexo" value="Otro" id="sexo_otro"
                                                           class="gender-input" {{ old('Sexo', $proveedor->Sexo) == 'Otro' ? 'checked' : '' }}>
                                                    <div class="selection-indicator">
                                                        <i class="fas fa-check"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group-enhanced">
                                            ...
                                            <div class="input-wrapper" data-required="true">
                                                ...
                                                <input type="text" 
                                                       ...
                                                       value="{{ old('Empresa_asociada', $proveedor->Empresa_asociada) }}" 
                                            ...
                                            <div class="input-meta">
                                                <div class="char-counter">
                                                    <i class="fas fa-text-height"></i>
                                                    <span id="empresaCount">{{ strlen($proveedor->Empresa_asociada) }}/255</span>
                                                </div>
                                            </div>
...
class FormManager {
    ...
    restoreOriginalData() {
        ...
        document.getElementById('ApPaterno').value = originalData.apPaterno;
        document.getElementById('ApMaterno').value = originalData.apMaterno;
        document.getElementById('Empresa_asociada').value = originalData.empresa;
        document.getElementById('Correo').value = originalData.correo;
        document.getElementById('Telefono').value = originalData.telefono;
        
        // Restaurar género
        this.selectGender(originalData.sexo);
        
        // Actualizar contadores
        this.updateCharCounter('nombreCount', originalData.nombre.length, 255);
        this.updateCharCounter('apPaternoCount', originalData.apPaterno.length, 255);
        this.updateCharCounter('apMaternoCount', originalData.apMaterno.length, 255);
        this.updateCharCounter('empresaCount', originalData.empresa.length, 255);
    ...
    updateNombreCompleto() {
        ...
        if (preview) {
            ...
            preview.parentElement.parentElement.classList.add('updated');
            setTimeout(() => {
                preview.parentElement.parentElement.classList.remove('updated');
            }, 1000);
        }
    }
    ...
    validateAndSubmit() {
        if (this.validateAllFields()) {
            ...
            notifier.showWarning('Por favor, complete todos los campos requeridos correctamente');
        }
    }
        ...
        Swal.fire({
            ...
            html: `
                <div class="text-start">
                    <p class="mb-3"><strong>Proveedor a actualizar:</strong></p>
                    <div class="alert alert-primary" style="background: rgba(102, 126, 234, 0.1); border: none; border-radius: 12px;">
                        <p class="mb-2"><i class="fas fa-user me-2 text-primary"></i>${currentData.nombre} ${currentData.apPaterno} ${currentData.apMaterno}</p>
                        <p class="mb-2"><i class="fas fa-building me-2 text-primary"></i>${currentData.empresa}</p>
                        <p class="mb-2"><i class="fas fa-envelope me-2 text-primary"></i>${currentData.correo}</p>
                        <p class="mb-0"><i class="fas fa-phone me-2 text-primary"></i>${currentData.telefono}</p>
                    </div>
                    <div class="alert alert-warning mt-3" style="background: rgba(245, 158, 11, 0.1); border: none; border-radius: 12px;">
    ...
    submitForm() {
        ...
        if (submitBtn && form) {
            notifier.showInfo('Actualizando proveedor...', 'Un momento por favor');

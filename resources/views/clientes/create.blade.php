                    ...
                    <div class="card-body p-4 p-lg-5">
                        ...
                        <div class="progress-overview mb-5">
                            ...
                            <div class="d-flex justify-content-between mt-2">
                                <small class="text-muted" id="completedFields">0 de 8 campos completados</small>
                        ...
                        <form id="clienteForm" action="{{ route('clientes.store') }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group-enhanced">
                                            ...
                                            <div class="gender-selector-grid" data-required="true" id="genderGroup">
                                                <div class="gender-option-card" data-gender="Masculino">
                                                ...
                                                <div class="gender-option-card" data-gender="Femenino">
                                                    <div class="gender-icon-wrapper">
                                        ...
                                        <div class="form-group-enhanced">
                                            ...
                                            <div class="preview-card p-3">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="mb-0 fw-bold" id="nombreCompletoPreview">-</h6>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group-enhanced">
                                            ...
                                            <div class="input-meta">
                                                <div class="char-counter">
                                                    <i class="fas fa-text-height"></i>
                                                    <span id="correoCount">0/100</span>
                                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group-enhanced">
                                            ...
                                            <div class="textarea-wrapper" data-required="true">
                                                ...
                                                <input type="text" 
                                                       class="input-field @error('Direccion') is-invalid @enderror" 
                                                       id="Direccion" 
                                                       name="Direccion" 
                                                       value="{{ old('Direccion') }}" 
                                                       ...
                                                       required
                                                       maxlength="255"
                                                       data-char-counter="direccionCount">
                                                <div class="input-decoration" style="background: linear-gradient(90deg, #28a745, #20c997);"></div>
                                            </div>
                                            ...
                                            <div class="input-meta">
                                                <div class="char-counter">
                                                    <i class="fas fa-text-height"></i>
                                                    <span id="direccionCount">0/255</span>
                                                </div>
                                                <div class="input-hint">
                                                    <i class="fas fa-info-circle"></i>
                                                    Dirección completa
                                    ...
                                    <div class="form-info">
                                        <div class="form-stats">
                                            ...
                                            <div class="stat-item">
                                                ...
                                                <span id="validFieldsCount">0/8</span> completados
                                            </div>
                                        </div>
                                    </div>
...
class FormManager {
    constructor() {
        this.requiredFields = [
            'Nombre', 'ApPaterno', 'Fecha_nacimiento', 'Sexo', 'Correo', 'Telefono', 'Direccion'
        ];
        this.init();
    }
    ...
    validateField(fieldId) {
        ...
        const wrapper = field.closest('.input-wrapper, .date-picker-wrapper, .phone-input-wrapper, .email-input-wrapper, .textarea-wrapper');
        if (!wrapper) return;
        ...
        if (fieldId === 'Fecha_nacimiento') {
            ...
            const fechaSeleccionada = new Date(field.value);
            const hoy = new Date();
    ...
    validateAllFields() {
        ...
        if (errors.length > 0) {
            ...
            if (firstError) {
                ...
                const wrapper = firstError.closest('.input-wrapper, .date-picker-wrapper, .phone-input-wrapper, .email-input-wrapper, .textarea-wrapper, .gender-selector-grid');
                if (wrapper) {
    ...
    initDatePicker() {
        ...
        if (dateField) {
            ...
            const maxFecha = new Date();
            maxFecha.setFullYear(hoy.getFullYear() - 18);
            dateField.max = maxFecha.toISOString().split('T')[0];
    ...
    calculateAge(dateString) {
        ...
        if (age >= 18) {
            ageCalculator.innerHTML = `
                ...
                <span style="color: #28a745">${age} años - Mayor de edad ✓</span>
            `;
        } else {
            ageCalculator.innerHTML = `
                <i class="fas fa-exclamation-triangle" style="color: #ef4444"></i>
                <span style="color: #ef4444">${age} años - Menor de edad ✗</span>
            `;
        }
    }

                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="mb-0 text-muted" style="font-size: 0.9rem;">
                                    ...
                                    Complete todos los campos para registrar una nueva venta
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="card-body p-4 p-lg-5">
                        ...
                        <div class="progress-overview mb-5">
                            ...
                            <div class="d-flex justify-content-between mt-2">
                                <small class="text-muted" id="completedFields">0 de 2 secciones completadas</small>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group-enhanced">
                                            ...
                                            <div class="select-wrapper" data-required="true">
                                                ...
                                                <div class="select-decoration" style="background: linear-gradient(90deg, #28a745, #20c997);"></div>
                                            </div>
                                            
                                            <div class="input-meta">
                                                <div class="input-hint">
                                                    <i class="fas fa-info-circle"></i>
                                                    Seleccione el empleado que realiza la venta
                                                </div>
                                            </div>
                                ...
                                <div class="section-header mb-4">
                                    <div class="d-flex align-items-center gap-3 mb-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="section-subtitle mb-0">Agregue los productos vendidos</p>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table table-modern" id="tablaProductos">
                                        ...
                                        <tfoot>
                                            <tr class="table-total">
                                                ...
                                                <td colspan="2">
                                                    <span class="total-amount" id="totalVenta">$0.00</span>
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>
                            ...
                            <div class="form-actions mt-5 pt-4 border-top">
                                <div class="d-flex flex-column flex-lg-row justify-content-between align-items-center gap-4">
                                    ...
                                    <div class="d-flex flex-wrap gap-3">
                                        <a href="{{ route('ventas.index') }}" class="btn btn-outline-secondary btn-action">
...
class VentaManager {
    ...
    setupEventListeners() {
        ...
        this.btnRegistrar = document.getElementById('submitBtn');
        ...
        selectProducto.addEventListener('change', () => {
            ...
            if (productoId) {
                ...
                if (this.productosSeleccionados.has(productoId)) {
                    notifier.showWarning('Este producto ya ha sido agregado a la venta');
        ...
        Swal.fire({
            ...
            html: `
                <div class="text-start">
                    <p>¿Está seguro de registrar la siguiente venta?</p>
            ...
            if (result.isConfirmed) {
                ...
                notifier.showInfo('Registrando venta...', 'Un momento por favor');
